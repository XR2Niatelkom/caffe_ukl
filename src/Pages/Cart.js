        ...
        <div className="container">
          <div className="card col-12 mt-5">
            ...
            <div className="card-body">
                        <h5 className="text" style={{ color: '#FFC7EA'}}>
                  ...
                  {this.state.cart.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        <button className="btn btn-sm m-1" style={{ color: '#A084E8'}} onClick={() => this.editItem(item)}>
                        ...
                        <button className="btn btn-sm m-1"  style={{ color: '#EA1179'}} onClick={() => this.dropItem(item)}>
              ...
              <h5 className="text" style={{ color: '#FE0000'}}>Total Harga: Rp{this.state.total}</h5>
            </div>
          </div>
          <br></br>
          <button
