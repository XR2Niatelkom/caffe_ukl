    ...
    return (
      <>
        ...
        <div class="card mt-3">
            ...
            <div className='alert text' style={{ backgroundColor: '#FEBBCC'}}>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        {item.dibayar === "dibayar" ? (
                          <button
                            className="btn m-1" style={{ color: '#A084E8'}}
                        ...
                        <button
                          className="btn m-1" style={{ color: '#EA1179'}}
              ...
              <Form onSubmit={(e) => this.handleSave(e)}>
                <Modal.Body>
                  ...
                  <div className="card col-12 mt-2">
                    <div className="card-header" style={{ backgroundColor: '#FEBBCC'}}>
