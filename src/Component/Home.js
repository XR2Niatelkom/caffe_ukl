    ...
    return (
      <div>
        ...
        <div className="container">
          ...
          <div className="alert text-black text-center">
            <h1 className="text-uppercase">
              <i>
                HELLO! WELCOME {this.state.userName.toUpperCase()}
              </i>
            </h1>
          </div>
          <hr />
          ...
          <div className="d-flex justify-content-around p-1">
            <div className="card col-6 m-1"  style={{ backgroundColor: '#FBF0B2'}}>
              <div className="card-body row">
                <div className="col-15 p-4">
                  <h2 className="text-center" style={{ color: '#5C5470'}}>Total User</h2>
                  <h2 className="text-center" style={{ color: '#5C5470'}}>
                    <i>{this.state.userCount}</i>
                  </h2>
                </div>
              </div>
            </div>
            <div className="card col-6 m-1" style={{ backgroundColor: '#CAEDFF'}}>
              <div className="card-body row">
                <div className="col-15 p-4">
                  <h2 className="text-center" style={{ color: '#5C5470'}}>Total Menu</h2>
                  <h2 className="text-center" style={{ color: '#5C5470'}}>
          ...
          <div className="d-flex justify-content-around p-1">
            <div className="card col-6 m-1" style={{ backgroundColor: '#D8B4F8'}}>
              <div className="card-body row">
                <div className="col-15 p-4">
                  <h2 className="text-center" style={{ color: '#5C5470'}}>Total Meja</h2>
                  <h2 className="text-center" style={{ color: '#5C5470'}}>
            ...
            <div className="card col-6 m-1" style={{ backgroundColor: '#FEBBCC'}}>
            <div className="card-body row">
              <div className="col-15 p-4">
                <h2 className="text-center" style={{ color: '#5C5470'}}>Total Transaksi</h2>
                <h2 className="text-center" style={{ color: '#5C5470'}}>
        ...
        {this.state.role === "manajer" ? (
                                <div>
                                    <div className="card justify-content-center align-items-center text-center">
                                        <h3 className="mt-4 mb-3" style={{ color: '#D8B4F8'}}>Favorite Menu Statistic</h3>
                                        <div className="mx-5 mt-4 mb-5">
                                            ...
                                            >
                                                ...
                                                <Bar dataKey="Penjualan" fill="#FFC7EA" background={{ fill: '#eee' }} />
                                            </BarChart>
                                        </div>
                                    </div>
                                    <div className="card justify-content-center align-items-center text-center mt-3">
                                        <h3 className="mt-4 mb-3" style={{ color: '#D8B4F8'}}>Least Menu Statistic</h3>
                                        <div className="mx-5 mt-4 mb-5">
                                            <BarChart
                                                width={800}
                                                height={300}
