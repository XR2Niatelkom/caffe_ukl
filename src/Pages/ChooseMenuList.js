    ...
    render(){
        ...
        <div className="col-lg-6 col-sm-12 p-2" >
            <div className="card">
                ...
                <div className="col-6">
                        <img src={this.props.gambar} className="gambar" height="200" width="200"/>
                    </div>
                    ...
                    <div className="col-6">
                        ...
                        <h6 className="text-dark">
                            Deskripsi     : { this.props.deksripsi}
                        </h6>
                        ...
                        <button className="btn btn-sm btn-success m-1"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16" style={{ color: '#A084E8'}} >
