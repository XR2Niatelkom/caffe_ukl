...
export default class User extends React.Component {
    ...
    render() {
        return (
            ...
            <div className='alert text-black mb-6'>
                        <h2 class="text-center"><b>Data User</b></h2>
	        </div>

            <div class="d-grid gap-2">
            <button className="btn btn-success" style={{ backgroundColor: '#FEBBCC'}} onClick={() => this.addUser()}>
                        Add User
                    </button>
                    </div>
                    <hr></hr>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            ...
                                            <button className="btn btn-sm m-1" style={{ color: '#A084E8'}} onClick={() => this.handleEdit(item)}>
                                            ...
                                            <button className="btn btn-sm m-1" style={{ color: '#EA1179'}} onClick={() => this.dropUser(item.id_user)}>
