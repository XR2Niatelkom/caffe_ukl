...
export default class Meja extends React.Component {
    ...
    render() {
        return (
            ...
            <button className="btn btn-success" style={{ backgroundColor: '#FEBBCC'}} onClick={() => this.addMeja()}>
                        Add Meja
                    </button>
                    </div>
                    <hr></hr>
                                ...
                                return (
                                    <tr key={index}>
                                        ...
                                        <td>
                                            ...
                                            <button className="btn btn-sm m-1" style={{ color: '#EA1179'}} onClick={() => this.dropMenu(item.id_meja)}>
